...
public class Location {
	...
	public Location(double longitude, double latitude, double speed,
			...
			String photo, String color, String deviceid, String colorCode) {
		super();
	...
	public String toString() {
		return "Location [longitude=" + longitude + ", latitude=" + latitude
				...
				+ fixtime + ", immatriculation=" + immatriculation + ", vin="
				+ vin + ", mark=" + mark + ", model=" + model + ", photo="
				+ photo + ", color=" + color + ", deviceid=" + deviceid
				+ ", colorCode=" + colorCode + "]";
	}
